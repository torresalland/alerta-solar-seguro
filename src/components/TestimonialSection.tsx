...
export const TestimonialSection = () => {
    return (
        <section className="py-40 bg-background text-foreground transition-colors duration-300 overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                <div className="text-center mb-20">
                    <h2 className="text-4xl lg:text-5xl font-bold mb-6 text-midnight dark:text-slate-200">O que dizem nossos clientes</h2>
                    <div className="h-1.5 w-24 bg-primary mx-auto rounded-full"></div>
                </div>
                <div className="grid md:grid-cols-3 gap-10">
                    <div className="bg-white dark:bg-slate-900 p-6 md:p-10 rounded-[2.5rem] shadow-premium border border-slate-50 dark:border-slate-800/80 flex flex-col justify-between h-full hover:-translate-y-2 transition-transform">
                        <div>
                            ...
                            <p className="text-slate-600 dark:text-slate-300 text-lg italic leading-relaxed mb-10">"Descobri que meu sistema era uma bomba relógio. A SolarSEMRISCO me ajudou a exigir a adequação imediata sem custos."</p>
                        </div>
                        <div className="flex items-center gap-4 pt-8 border-t border-slate-100 dark:border-slate-800">
                            ...
                            <div>
                                <p className="font-bold text-midnight dark:text-slate-200 leading-none mb-1">Roberto S.</p>
                    ...
                    <div className="bg-white dark:bg-slate-900 p-6 md:p-10 rounded-[2.5rem] shadow-premium border border-slate-50 dark:border-slate-800/80 flex flex-col justify-between h-full hover:-translate-y-2 transition-transform">
                        <div>
                            ...
                            <p className="text-slate-600 dark:text-slate-300 text-lg italic leading-relaxed mb-10">"Achei que o problema era meu, mas era erro da instaladora. Consegui a reparação total baseada na NBR 17.193."</p>
                        </div>
                        <div className="flex items-center gap-4 pt-8 border-t border-slate-100 dark:border-slate-800">
                            <div className="w-12 h-12 rounded-full bg-slate-200 overflow-hidden flex-shrink-0">
                            ...
                            <div>
                                <p className="font-bold text-midnight dark:text-slate-200 leading-none mb-1">Mariana L.</p>
                    ...
                    <div className="bg-white dark:bg-slate-900 p-6 md:p-10 rounded-[2.5rem] shadow-premium border border-slate-50 dark:border-slate-800/80 flex flex-col justify-between h-full hover:-translate-y-2 transition-transform">
                        <div>
                            ...
                            <p className="text-slate-600 dark:text-slate-300 text-lg italic leading-relaxed mb-10">"Processo transparente e muito técnico. Em poucos dias meu caso já estava qualificado e em andamento."</p>
                        </div>
                        <div className="flex items-center gap-4 pt-8 border-t border-slate-100 dark:border-slate-800">
                            <div className="w-12 h-12 rounded-full bg-slate-200 overflow-hidden flex-shrink-0">
                            ...
                            <div>
                                <p className="font-bold text-midnight dark:text-slate-200 leading-none mb-1">Carlos A.</p>
