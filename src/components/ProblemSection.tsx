...
export const ProblemSection = () => {
  return (
    <section className="py-40 bg-white" id="problema">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          <div className="relative">
            <div className="absolute -top-10 -left-10 w-64 h-64 bg-orange-50 rounded-full blur-3xl opacity-60"></div>
            <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-midnight mb-6 leading-[1.2] tracking-tight">
              O problema invisível que pode custar mais de <span className="text-primary font-extrabold">R$ 50.000</span> ao longo dos anos
            </h2>
            <span className="block text-2xl text-slate-400 font-medium mb-10">(Não conformidade técnica)</span>
            <div className="space-y-10">
              ...
              <div className="flex gap-6 group">
                ...
                <div>
                  <h4 className="text-xl font-bold mb-2">Risco Crítico: Inversores String</h4>
                  <p className="text-slate-500">O uso de inversores String <span className="text-primary font-bold">sem o dispositivo de desligamento rápido (RSD)</span> representa um risco grave à segurança, deixando você <span className="text-midnight font-semibold italic underline decoration-red-200">deixando de buscar um direito que é seu</span> por uma instalação segura.</p>
                </div>
              </div>
              <div className="flex gap-6 group">
                <div className="flex-shrink-0 w-12 h-12 rounded-full border border-red-100 flex items-center justify-center text-red-500 bg-red-50/50 group-hover:bg-red-50 transition-colors">
                ...
                <div>
                  <h4 className="text-xl font-bold mb-2">Insegurança Jurídica</h4>
                  <p className="text-slate-500">Sistemas fora da norma perdem garantia de fábrica e podem ter a cobertura de seguro negada em caso de sinistro, gerando prejuízo total ao proprietário.</p>
                </div>
              </div>
            </div>
          </div>
          <div className="bg-midnight p-8 md:p-12 lg:p-16 rounded-[3rem] shadow-premium relative overflow-hidden group">
